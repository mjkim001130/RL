...
parser.add_argument('--EnvIdex', type=int, default=0, help='CartPoleV1, LunarV2')
...
def main():
    ...
    BriefEnvName = ['CartPoleV1', 'LunarV2']
    ...
    if opt.render:
        ...
        while total_steps < opt.Max_train_steps:
            ...
            while not done:
                ...
                '''Update'''
                # train 50 times every 50 steps rather than 1 training per step
...
# --Max_train_steps 500000 이런식으로 최대 학습수 제한
